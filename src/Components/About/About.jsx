...
//             </div> */}
//             <div className="about-left">
//   <div className="about-profile-flip">
//     <div className="about-profile-inner">
//       <div className="about-profile-front">
//         <img className="about-profile" src={profile_img} alt="Profile" />
//       </div>
//       <div className="about-profile-back">
//         <h3>Boobesh Palanisamy</h3>
//         <p>Designer and Developer</p>
//         {/* add social icons, quote, whatever you like */}
//       </div>
//     </div>
//   </div>
// </div>
  ...
  return (
    ...
    <div className="about-title">
      ...
      <img className="about-pattern" src={theme_pattern} alt="" />
        ...
        <div className="about-sections">
            <AboutProfile profile_img={profile_img} />
            <div className="about-right">
              <div className="about-para">
                <p>I am an aspiring UI/UX Designer and React.js Developer passionate about creating intuitive and responsive web applications. I have gained hands-on experience through projects, practice, and continuous learning. I am eager to apply my skills, grow professionally, and contribute to impactful digital products.</p>
                <p>My passion for frontend development is reflected in my enthusiasm for learning and the dedication I bring to every project and practice task I take on.</p>
...
/* =========================
   Flip card + cursor-follow tilt combined
========================= */
function AboutProfile({ profile_img }) {
  ...
  const handleMouseMove = (e) => {
    ...
    wrap.style.transform = `perspective(1200px) rotateX(${rotateX}deg) rotateY(${rotateY}deg) scale(1.03)`;

    const shadowX = ((x - centerX) / centerX) * -20;
    const shadowY = ((y - centerY) / centerY) * -20;
    wrap.style.boxShadow = `${shadowX}px ${shadowY + 20}px 40px rgba(0,0,0,0.4), 0 0 30px rgba(0,230,255,0.2)`;
  };

  const handleMouseLeave = () => {
    const wrap = wrapRef.current;
    wrap.style.transform = `perspective(1200px) rotateX(0deg) rotateY(0deg) scale(1)`;
    wrap.style.boxShadow = `0 8px 20px rgba(0,0,0,0.3)`;
  };

  return (
    <div className="about-left">
      <div
        className="about-profile-flip"
        ref={wrapRef}
